...
class MyActions(models.Model):
    ...
    def download_rapport_intervention_valide (self):
        ...
        return {
            'warning': {
                'title': "Rapport d'intervention valide",
                'message': f"Cet évènement comporte {str(report_count)} rapport d'intervention validé. Pour y accéder veuillez ouvrir l'évènement et cliquer sur l'onglet \"Rapport validé\""}
        }
