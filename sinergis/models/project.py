...
class ProjectTask(models.Model):
    ...
    create_sale_line_id = fields.Many2one("sale.order.line", string="Ligne de commande à la création", default=lambda self: self.sale_line_id)
    ...
    def _compute_x_sinergis_project_task_contract_type (self):
        for rec in self :
            if rec.project_id:
                ...
                rec.x_sinergis_project_task_contract_type = False
